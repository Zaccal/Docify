...
-- Preserve REFUND_CANCELLATION values introduced by migration 0028.
CREATE TYPE "public"."cost_transaction_reason" AS ENUM('NEW_ORDER', 'REFUND_CANCELLATION', 'CANCELLATION', 'REFUND');--> statement-breakpoint
