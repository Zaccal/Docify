...
import { NavDocuments } from '@Docify/ui/components/nav-documents'
import { NavMain } from '@Docify/ui/components/nav-main'
import { NavSecondary } from '@Docify/ui/components/nav-secondary'
import { NavUser } from '@Docify/ui/components/nav-user'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
